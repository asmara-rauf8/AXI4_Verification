class w_slave_monitor extends uvm_monitor;
  `uvm_component_utils(w_slave_monitor)

  env_cfg cfg;
  virtual slave_if vif;
  uvm_analysis_port #(w_tx) analysis_port;

  function new(string name = "w_slave_monitor", uvm_component parent = null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (!uvm_config_db#(env_cfg)::get(this, "", "cfg", cfg)) `uvm_fatal("W_S_MON", "cfg missing")
    vif = cfg.slave_vif;
  endfunction
