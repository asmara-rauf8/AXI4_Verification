class aw_master_monitor extends uvm_monitor;
  `uvm_component_utils(aw_master_monitor)

  env_cfg cfg;
  virtual master_if vif;
  uvm_analysis_port #(aw_tx) analysis_port;

  function new(string name = "aw_master_monitor", uvm_component parent = null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (!uvm_config_db#(env_cfg)::get(this, "", "cfg", cfg)) `uvm_fatal("AW_M_MON", "cfg missing")
    vif = cfg.master_vif;
  endfunction
